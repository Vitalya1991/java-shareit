...
class UserServiceImplTest {
    ...
    void testAddUser() {
        ...
        UserResponseDto actualAddUserResult = userStorageImpl.addUser(new UserRequestDto("Name", "jane.doe@example.org"));
    ...
    void testAddUserNotFoundException() {
        ...
        assertThrows(NotFoundException.class,
                () -> userStorageImpl.addUser(new UserRequestDto("Name", "jane.doe@example.org")));
        verify(userJpaRepository).save((User) any());
    }
    ...
    void testUpdateUser() {
        ...
        UserResponseDto actualUpdateUserResult = userStorageImpl
    ...
    void testUpdateUserNotFoundException() {
        ...
        when(userJpaRepository.existsById((Long) any())).thenReturn(true);
        assertThrows(NotFoundException.class,
                () -> userStorageImpl.updateUser(new UserRequestDto("Name", "jane.doe@example.org"), 1L));
        verify(userJpaRepository).existsById((Long) any());
        verify(userJpaRepository).getReferenceById((Long) any());
        verify(userJpaRepository).save((User) any());
    }
    ...
    void testGetUserById() {
        ...
        when(userJpaRepository.getReferenceById((Long) any())).thenReturn(user);
        when(userJpaRepository.existsById((Long) any())).thenReturn(true);
        UserResponseDto actualUserById = userStorageImpl.getUserById(1L);
    ...
    void testGetUserByIdNotFoundException() {
        ...
        when(userJpaRepository.existsById((Long) any())).thenReturn(true);
        assertThrows(NotFoundException.class, () -> userStorageImpl.getUserById(1L));
        verify(userJpaRepository).existsById((Long) any());
        verify(userJpaRepository).getReferenceById((Long) any());
    }
    ...
    void testDeleteUserById() {
        ...
        when(userJpaRepository.existsById((Long) any())).thenReturn(true);
        userStorageImpl.deleteUserById(1L);
        verify(userJpaRepository).existsById((Long) any());
    ...
    void testDeleteUserByIdNotFoundException() {
        ...
        when(userJpaRepository.existsById((Long) any())).thenReturn(true);
        assertThrows(NotFoundException.class, () -> userStorageImpl.deleteUserById(1L));
        verify(userJpaRepository).existsById((Long) any());
        verify(userJpaRepository).deleteById((Long) any());
    }
    ...
    void testGetUsers() {
        ...
        assertTrue(userStorageImpl.getUsers().isEmpty());
    ...
    void testGetUser() {
        ...
        List<UserResponseDto> actualUsers = userStorageImpl.getUsers();
    ...
    void testGetUsersNotFoundEx() {
        ...
        assertThrows(NotFoundException.class, () -> userStorageImpl.getUsers());
        verify(userJpaRepository).findAll();
    }
